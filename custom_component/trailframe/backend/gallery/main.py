...
from gallery.api.about import router as about_router
from gallery.api.activities import router as activities_router
from gallery.api.configuration import router as configuration_router
from gallery.api.events import router as events_router
from gallery.api.map_data import router as map_data_router
from gallery.api.models import router as models_router
from gallery.api.photos import router as photos_router
from gallery.api.pipeline import router as pipeline_router
from gallery.api.statistics import router as statistics_router
from gallery.api.tiles import router as tiles_router
from gallery.services.activity_service import ActivityService
from gallery.services.configuration_service import ConfigurationService
...
def create_app(args: argparse.Namespace) -> FastAPI:
    ...
    pkg_dist = Path(str(resources.files("gallery") / "frontend" / "dist"))
